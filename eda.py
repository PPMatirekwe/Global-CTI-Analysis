...
# Updated pie chart function to only show percentages inside the pie
def plot_pie_chart(data, title):
    ...
    # Set the text to show percentages only inside the pie
...
def plot_event_distributions(df):
    ...
    fig, axs = plt.subplots(3, 2, figsize=(18, 20))  # Adjust the figure size here
    ...
    axs[2, 0].tick_params(axis='x', rotation=45)  # Rotate region labels to avoid overlap
